...
// #~~~~~~~~~~~~~~~~~~~~~~~~~~~ begin custom tmc functions ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
bool UMobileNativeCodeBlueprint::detectAccessory_new(){
  bool Result = false;
  #if PLATFORM_ANDROID
...
FString  UMobileNativeCodeBlueprint::detectAccessory(){
  FString Result = TEXT("");
  #if PLATFORM_ANDROID
...
FString  UMobileNativeCodeBlueprint::attachAndSendByte(){
  FString Result = TEXT("");
  #if PLATFORM_ANDROID
    Result = AndroidUtils::CallJavaCode<FString>(
      "com/Plugins/MobileNativeCode/AndroidOpenAccessBridge",
      "maybeAttachAccessory",
      "",
      true
    );
  #endif
...
FString UMobileNativeCodeBlueprint::testLocalFunction(){
//
  FString Result = TEXT("");
  // return Result; 
...
// #~~~~~~~~~~~~~~~~~~~~~~~~~~~ end custom tmc functions ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

// #~~~~~~~~~~~~~~~~~~~~~~~~~~~ begin 1 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
FString UMobileNativeCodeBlueprint::HelloWorldTest(FString MyStr /*= "Hello World"*/)
{
#if PLATFORM_ANDROID
